...
wget -c http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-8000-1.0.11.tar.gz
wget -c http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-16000-1.0.11.tar.gz
wget -c http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-32000-1.0.11.tar.gz
wget -c http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-48000-1.0.11.tar.gz

######################################################################################################################
#
# spec file for package fluxpbx
#
# includes module(s): fluxpbx-devel fluxpbx-codec-passthru-amr fluxpbx-codec-passthru-amrwb fluxpbx-codec-passthru-g729 
#                     fluxpbx-codec-passthru-g7231 fluxpbx-lua fluxpbx-mariadb fluxpbx-pgsql fluxpbx-perl fluxpbx-python fluxpbx-v8 fluxpbx-signalwire
#                     fluxpbx-lan-de fluxpbx-lang-en fluxpbx-lang-fr fluxpbx-lang-hu fluxpbx-lang-ru
#		      and others
#
...
#%define sysconfdir	/etc/fluxpbx
#%define _sysconfdir	%{sysconfdir}
#%define logfiledir	/var/log/fluxpbx
#%define _logfiledir	%{logfiledir}
#%define runtimedir	/var/run/fluxpbx
#%define _runtimedir	%{runtimedir}

######################################################################################################################
# Layout of packages FHS (Redhat/SUSE), FS (Standard FluxPBX layout using /usr/local), OPT (/opt based layout)
...
Name:         	fluxpbx
Summary:      	FluxPBX open source telephony platform
License:      	MPL1.1
...
%description
FluxPBX is an open source telephony platform designed to facilitate the creation of voice 
...
FluxPBX runs on several operating systems including Windows, Max OS X, Linux, BSD and Solaris 
...
%package devel
Summary:        Development package for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description devel
FluxPBX development files

######################################################################################################################
#				FluxPBX Application Modules
######################################################################################################################
%package application-abstraction
Summary:	FluxPBX mod_abstraction
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-abstraction
Provide an abstraction to FluxPBX API calls

%package application-avmd
Summary:	FluxPBX voicemail detector
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-avmd
Provide an voicemail beep detector for FluxPBX

%package application-blacklist
Summary:	FluxPBX blacklist module
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
...
Summary:	FluxPBX mod_callcenter Call Queuing Application
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-callcenter
Provide Automated Call Distribution capabilities for FluxPBX

%package application-cidlookup
Summary:	FluxPBX mod_cidlookup 
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-cidlookup
Provide FluxPBX access to third party CallerID Name Databases via HTTP

%package application-conference
Summary:	FluxPBX mod_conference
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-conference
Provide FluxPBX Conference Bridge Services. 

%package application-curl
Summary:	FluxPBX mod_curl
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-curl
Provide FluxPBX dialplan access to CURL

%package application-db
Summary:	FluxPBX mod_db
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-db
mod_db implements an API and dialplan interface to a database backend for 
FluxPBX.  The database can either be in sqlite or ODBC.  It also provides 
support for group dialing and provides database backed limit interface. 

%package application-directory
Summary:	FluxPBX mod_directory
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-directory
Provides FluxPBX mod_directory, a dial by name directory application.

%package application-distributor
Summary:	FluxPBX mod_distributor
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-distributor
Provides FluxPBX mod_distributor, a simple round-robin style distribution
to call gateways.

%package application-easyroute
Summary:	FluxPBX mod_easyroute
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-easyroute
Provides FluxPBX mod_easyroute, a simple, easy to use DB Backed DID routing 
Engine. Uses ODBC to connect to the DB of your choice.

%package application-enum
Summary:	FluxPBX mod_enum
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  ldns-devel

%description application-enum
Provides FluxPBX mod_enum, a ENUM dialplan, with API and Dialplan extensions 
supporting ENUM lookups.

%package application-esf
Summary:	FluxPBX mod_esf
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-esf
Provides FluxPBX mod_esf, Extra Sip Functionality such as Multicast Support

%if %{build_mod_esl}
%package application-esl
Summary:	FluxPBX mod_esl
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-esl
Provides FluxPBX mod_esl, add api commands for remote ESL commands
%endif

%package application-expr
Summary:	FluxPBX mod_expr
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-expr
Provides FluxPBX mod_expr, implements Brian Allen Vanderburg's ExprEval 
expression evaluation library for FluxPBX.

%package application-fifo
Summary:	FluxPBX mod_fifo
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-fifo
Provides FluxPBX mod_fifo, a parking-like app which allows you to make 
custom call queues

%package application-fsk
Summary:	FluxPBX mod_fsk
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-fsk
Provides FluxPBX mod_fsk, a module to send and receive information via 
Frequency-shift keying

%package application-fsv
Summary:	FluxPBX mod_fsv
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-fsv
Provides FluxPBX mod_fsk, implements functions to record and play back video

%package application-hash
Summary:	FluxPBX mod_hash
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-hash
Provides FluxPBX mod_hash, implements an API and application interface for 
manipulating a hash table. It also provides a limit backend. 

%package application-httapi
Summary:	FluxPBX mod_httapi
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-httapi
Provides FluxPBX mod_httapi, provides an HTTP based Telephony API using a 
standard FluxPBX application interface as well as a cached http file format 
interface

%package application-http-cache
Summary:	FluxPBX mod_http_cache
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-http-cache
Provides FluxPBX mod_http_cache, allows one to make a HTTP GET request to 
cache a document. The primary use case is to download and cache audio files 
from a web server. 

%package application-lcr
Summary:	FluxPBX mod_lcr
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-lcr
Provides FluxPBX mod_lcr, provide basic Least Cost Routing Services

%package application-limit
Summary:	FluxPBX mod_limit
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-limit
Provides FluxPBX mod_limit, provide application to limit both concurrent and call per time period

%package application-memcache
Summary:	FluxPBX mod_memcache
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  libmemcached-devel

%description application-memcache
Provides FluxPBX mod_memcache, implements an API interface to memcached which
...
Summary:	FluxPBX mod_mongo
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
BuildRequires:  mongo-c-driver-devel

%description application-mongo
Provides FluxPBX mod_mongo, which implements an API interface to mongodb.

%package application-nibblebill
Summary:	FluxPBX mod_nibblebill
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-nibblebill
Provides FluxPBX mod_nibblebill, provides a credit/debit module for 
FluxPBX to allow real-time debiting of credit or cash from a database 
while calls are in progress.

%package application-rad_auth
Summary:	FluxPBX mod_rad_auth
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-rad_auth
Provides FluxPBX mod_rad_auth, authentication via RADIUS protocol from FluxPBX dialplan

%package application-redis
Summary:	FluxPBX mod_redis
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-redis
Provides FluxPBX mod_redis, access to the redis key value pair db system from
FluxPBX

%package application-rss
Summary:	FluxPBX mod_rss
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-rss
Provides FluxPBX mod_rss, edisrse and read an XML based RSS feed, then read
the entries aloud via a TTS engine

%package application-signalwire
Summary:	FluxPBX mod_signalwire
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  libks2 signalwire-client-c2

%description application-signalwire
Provides FluxPBX mod_signalwire

%package application-sms
Summary:	FluxPBX mod_sms
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-sms
Provides FluxPBX mod_sms, provide a way to route messages in fluxpbx, 
...
Summary:	FluxPBX mod_snapshot
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-snapshot
Provides FluxPBX mod_snapshot, allows recording a sliding window of audio 
and taking snapshots to disk. 

%package application-snom
Summary:	FluxPBX mod_snom
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-snom
Provides FluxPBX mod_snom, an application for controlling the functionality 
and appearance of the programmable softkeys on Snom phones

%package application-soundtouch
Summary:	FluxPBX mod_soundtouch
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  soundtouch-devel >= 1.7.1

%description application-soundtouch
Provides FluxPBX mod_soundtouch, uses the soundtouch library, which can do
...
Summary:	FluxPBX mod_spy
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-spy
Provides FluxPBX mod_spy, implements userspy application which provides 
persistent eavesdrop on all channels bridged to a certain user

%package application-stress
Summary:	FluxPBX mod_stress
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-stress
Provides FluxPBX mod_stress. mod_stress attempts to detect stress in a 
person's voice and generates FluxPBX events based on that data. 

%package application-translate
Summary:	FluxPBX mod_translate
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-translate
Provide an number translation to FluxPBX API calls

%package application-valet_parking
Summary:	FluxPBX mod_valet_parking
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-valet_parking
Provides FluxPBX mod_valet_parking. Provides 'Call Parking' in the switch
as opposed to on the phone and allows for a number of options to handle call
retrieval

%package application-video_filter
Summary:	FluxPBX video filter bugs
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
...
Summary:	FluxPBX mod_voicemail
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-voicemail
Provides FluxPBX mod_voicemail. Implements Voicemail Application 

%package application-voicemail-ivr
Summary:	FluxPBX mod_voicemail_ivr
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-voicemail-ivr
Provides FluxPBX mod_voicemail_ivr. Provides a custimizable audio navigation 
system for backend voicemail systems

######################################################################################################################
#				FluxPBX ASR TTS Modules
######################################################################################################################

%package asrtts-flite
Summary:	FluxPBX mod_flite
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
...
Provides FluxPBX mod_flite, a interface to the flite text to speech engine

%package asrtts-pocketsphinx
Summary:	FluxPBX mod_pocketsphinx
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  bison

%description asrtts-pocketsphinx
Provides FluxPBX mod_pocketsphinx, a interface to the OpenSource 
Pocketsphinx speech recognition engine

%package asrtts-tts-commandline
Summary:	FluxPBX mod_tts_commandline
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description asrtts-tts-commandline
Provides FluxPBX mod_tts_commandline, Run a command line and play the 
output file.

######################################################################################################################
#				FluxPBX Codec Modules
######################################################################################################################

%package codec-passthru-amr
Summary:        Pass-through AMR Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Conflicts:	codec-amr

%description codec-passthru-amr
Pass-through AMR Codec support for FluxPBX open source telephony platform

%package codec-passthru-amrwb
Summary:        Pass-through AMR WideBand Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Conflicts:      codec-amrwb

%description codec-passthru-amrwb
Pass-through AMR WideBand Codec support for FluxPBX open source telephony platform

%package codec-bv
Summary:        BroadVoice16 and BroadVoice32 WideBand Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  broadvoice-devel

%description codec-bv
BroadVoice16 and BroadVoice32 WideBand Codec support for FluxPBX open source telephony platform

%package codec-codec2
Summary:        Codec2 Narrow Band Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  codec2-devel

%description codec-codec2
CODEC2 narrow band codec support for FluxPBX open source telephony platform.
CODEC2 was created by the developers of Speex.

%package codec-passthru-g723_1
Summary:        Pass-through g723.1 Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Conflicts:	codec-g723_1

%description codec-passthru-g723_1
Pass-through g723.1 Codec support for FluxPBX open source telephony platform

%package codec-passthru-g729
Summary:        Pass-through g729 Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Conflicts:	codec-com-g729

%description codec-passthru-g729
Pass-through g729 Codec support for FluxPBX open source telephony platform

%package codec-h26x
Summary:        H.263/H.264 Video Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description codec-h26x
H.263/H.264 Video Codec support for FluxPBX open source telephony platform

%package codec-ilbc
Summary:        iLCB Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Requires:       ilbc2
...
iLBC Codec support for FluxPBX open source telephony platform

%package codec-isac
Summary:        iSAC Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description codec-isac
iSAC Codec support for FluxPBX open source telephony platform

%package codec-vpx
Summary:        vp8 Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
...
%package codec-mp4v
Summary:        MP4V Video Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description codec-mp4v
MP4V Video Codec support for FluxPBX open source telephony platform

%package codec-opus
Summary:        Opus Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Requires:       opus >= 1.1
...
OPUS Codec support for FluxPBX open source telephony platform
...
%package codec-silk
Summary:        Silk Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  libsilk-devel

%description codec-silk
Silk Codec (from Skype) support for FluxPBX open source telephony platform

%package codec-siren
Summary:        Siren Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  g722_1-devel

%description codec-siren
Siren Codec support for FluxPBX open source telephony platform. Using 
...
Summary:        Theora Video Codec support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description codec-theora
Theora Video Codec support for FluxPBX open source telephony platform.

######################################################################################################################
#				FluxPBX Database Modules
######################################################################################################################

%package database-mariadb
Summary:	MariaDB native support for FluxPBX
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
...
MariaDB native support for FluxPBX.

%package database-pgsql
Summary:	PostgreSQL native support for FluxPBX
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
...
PostgreSQL native support for FluxPBX.

######################################################################################################################
#				FluxPBX Directory Modules
######################################################################################################################

#%package directory-ldap
#Summary:        LDAP Directory support for FluxPBX open source telephony platform
#Group:          System/Libraries
#Requires:       %{name} = %{version}-%{release}

#%description directory-ldap
#LDAP Directory support for FluxPBX open source telephony platform.

######################################################################################################################
#				FluxPBX Endpoint Modules
######################################################################################################################

#%package endpoint-gsmopen
#Summary:        Generic GSM endpoint support for FluxPBX open source telephony platform
#Group:          System/Libraries
#Requires:       %{name} = %{version}-%{release}
#
#%description endpoint-gsmopen
#GSMopen is an endpoint (channel driver) that allows an SMS to be sent or 
#received from FluxPBX as well as incoming and outgoing GSM voice calls.
#SMS is handled via the standard CHAT API in FluxPBX.

#%package endpoint-h323
#Summary:        H.323 endpoint support for FluxPBX open source telephony platform
#Group:          System/Libraries
#Requires:       %{name} = %{version}-%{release}
#
#%description endpoint-h323
#H.323 endpoint support for FluxPBX open source telephony platform

#%package endpoint-khomp
#Summary:        khomp endpoint support for FluxPBX open source telephony platform
#Group:          System/Libraries
#Requires:       %{name} = %{version}-%{release}
#
#%description endpoint-khomp
#Khomp hardware endpoint support for FluxPBX open source telephony platform.

%package endpoint-portaudio
Summary:        PortAudio endpoint support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Requires:	alsa-lib
...
PortAudio endpoint support for FluxPBX open source telephony platform.

%package endpoint-rtmp
Summary:        RTPM Endpoint support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description endpoint-rtmp
RTMP Endpoint support for FluxPBX open source telephony platform. Allows FluxPBX
to be used from a RTMP client. See http://wiki.fluxpbx.org/wiki/Mod_rtmp#Flex_Client
for the OpenSouce FluxPBX backed Client.

%package endpoint-skinny
Summary:        Skinny/SCCP endpoint support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description endpoint-skinny
SCCP/Skinny support for FluxPBX open source telephony platform.

%package endpoint-verto
Summary:        Verto endpoint support for FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description endpoint-verto
Verto protocol support for FluxPBX open source telephony platform.
...
######################################################################################################################
#				FluxPBX Event Handler Modules
######################################################################################################################

%package event-cdr-mongodb
Summary:	MongoDB CDR Logger for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:       %{name} = %{version}-%{release}
BuildRequires:  mongo-c-driver-devel

%description event-cdr-mongodb
MongoDB CDR Logger for FluxPBX

%package event-cdr-pg-csv
Summary:	PostgreSQL CDR Logger for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
Requires:	postgresql-libs
BuildRequires:	postgresql-devel
...
PostgreSQL CDR Logger for FluxPBX.

%package event-cdr-sqlite
Summary:	SQLite CDR Logger for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	 %{name} = %{version}-%{release}

%description event-cdr-sqlite
SQLite CDR Logger for FluxPBX.

%package event-erlang-event
Summary:	Erlang Event Module for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	 %{name} = %{version}-%{release}
Requires:	erlang
...
Erlang Event Module for FluxPBX.

%package event-format-cdr
Summary:        JSON and XML Logger for the FluxPBX open source telephony platform
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}

%description event-format-cdr
JSON and XML Logger for the FluxPBX open source telephony platform

%package kazoo
Summary:	Kazoo Module for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
Requires:	erlang
BuildRequires:	erlang
...
%description kazoo
Kazoo Module for FluxPBX.

%package event-multicast
Summary:	Multicast Event System for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description event-multicast
Multicast Event System for FluxPBX.

#%package event-zmq
#Summary:	ZeroMQ Event System for the FluxPBX open source telephony platform
#Group:		System/Libraries
#Requires:	 %{name} = %{version}-%{release}
#
#%description event-zmq
#ZeroMQ Event System for FluxPBX.

%package event-json-cdr
Summary:	JSON CDR Logger for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description event-json-cdr
JSON CDR Logger for FluxPBX.

%package event-radius-cdr
Summary:        RADIUS Logger for the FluxPBX open source telephony platform
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}

%description event-radius-cdr
RADIUS Logger for the FluxPBX open source telephony platform

%if %{build_mod_rayo}
%package event-rayo
Summary:        Rayo (XMPP 3PCC) server for the FluxPBX open source telephony platform
Group:          System/Libraries
Requires:	%{name} = %{version}-%{release}

%description event-rayo
Rayo 3PCC for FluxPBX.  http://rayo.org   http://xmpp.org/extensions/xep-0327.html
Rayo is an XMPP protocol extension for third-party control of telephone calls.
%endif

%package event-snmp
Summary:	SNMP stats reporter for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
Requires:	net-snmp
...
SNMP stats reporter for the FluxPBX open source telephony platform

######################################################################################################################
#				FluxPBX Logger Modules
######################################################################################################################
...
######################################################################################################################
#				FluxPBX Media Format Modules
######################################################################################################################

%package format-local-stream
Summary:	Local File Streamer for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description format-local-stream
Local File Streamer for FluxPBX. It streams files from a directory and 
...
Summary:	Native Media File support for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description format-native-file
The native file module is designed to make it easy to play sound files where no
transcoding is necessary. The default FluxPBX sound files are in wav format.
Generally, these require transcoding when being played to callers. However, if
a native format sound file is available then FluxPBX can use it. 

%package format-portaudio-stream
Summary:	PortAudio Media Steam support for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
BuildRequires:	portaudio-devel

%description format-portaudio-stream
Portaudio Streaming interface Audio for FluxPBX

%package format-shell-stream
Summary:	Implements Media Steaming from arbitrary shell commands for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description format-shell-stream
Mod shell stream is a FluxPBX module to allow you to stream audio from an 
...
Mod Shout is a FluxPBX module to allow you to stream audio from MP3s or a i
shoutcast stream.
...
Mod Opusfile is a FluxPBX module to allow you to play Opus encoded files

%if %{build_mod_ssml}
%package format-ssml
Summary:        Adds Speech Synthesis Markup Language (SSML) parser format for the FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description format-ssml
mod_ssml is a FluxPBX module that renders SSML into audio.  This module requires a text-to-speech module for speech synthesis.
%endif

%package format-tone-stream
Summary:	Implements TGML Tone Generation for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}

%description format-tone-stream
Implements TGML Tone Generation for the FluxPBX open source telephony platform

######################################################################################################################
#				FluxPBX Programming Language Modules
######################################################################################################################

%package lua
Summary:	Lua support for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
...
%package	perl
Summary:	Perl support for the FluxPBX open source telephony platform
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
Requires:	perl
...
%package        python
Summary:        Python support for the FluxPBX open source telephony platform
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}
Requires:       python
...
%if %{build_mod_v8}
%package v8
Summary:	JavaScript support for the FluxPBX open source telephony platform, using Google V8 JavaScript engine
Group:		System/Libraries
Requires:	%{name} = %{version}-%{release}
...
%package lang-en
Summary:	Provides english language dependent modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-ru
Summary:        Provides russian language dependent modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-fr
Summary:        Provides french language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-de
Summary:        Provides german language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-he
Summary:        Provides hebrew language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-es
Summary:        Provides Spanish language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-pt
Summary:        Provides Portuguese language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
%package lang-sv
Summary:        Provides Swedish language dependend modules and speech config for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}
...
######################################################################################################################
#				FluxPBX Timer Modules
######################################################################################################################

%package timer-posix
Summary:        Provides posix timer for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}

%description timer-posix
Provides posix timer for the FluxPBX Open Source telephone platform.

%if %{build_timerfd}
%package timer-timerfd
Summary:        Provides Linux Timerfs based timer for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}

%description timer-timerfd
Provides Linux Timerfs based timer for the FluxPBX Open Source telephone 
platform.
%endif

######################################################################################################################
#				FluxPBX XML INT Modules
######################################################################################################################

%package xml-cdr
Summary:        Provides XML CDR interface for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description xml-cdr
Provides XML CDR interface for the FluxPBX Open Source telephone platform.

%package xml-curl
Summary:        Provides XML Curl interface for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description xml-curl
Provides XML Curl interface for the FluxPBX Open Source telephone platform.
Pull dynamic XML configs for FluxPBX over HTTP.

%package xml-rpc
Summary:        Provides XML-RPC interface for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:        %{name} = %{version}-%{release}

%description xml-rpc
Provides XML-RPC interface for the FluxPBX Open Source telephone platform.

######################################################################################################################
#			FluxPBX ESL language modules
######################################################################################################################

%package	-n perl-ESL
Summary:	The Perl ESL module allows for native interaction with FluxPBX over the event socket interface.
Group:		System Environment/Libraries

%description	-n perl-ESL
The Perl ESL module allows for native interaction with FluxPBX over the event socket interface.

%package	-n python-ESL
Summary:	The Python ESL module allows for native interaction with FluxPBX over the event socket interface.
Group:		System Environment/Libraries
Requires:	python
BuildRequires:	python-devel

%description	-n python-ESL
The Python ESL module allows for native interaction with FluxPBX over the event socket interface.

######################################################################################################################
#				FluxPBX basic config module
######################################################################################################################

%package config-vanilla
Summary:        Basic vanilla config set for the FluxPBX Open Source telephone platform.
Group:          System/Libraries
Requires:	%{name} = %{version}-%{release}
Requires:	fluxpbx-application-abstraction
Requires:	fluxpbx-application-avmd
Requires:	fluxpbx-application-blacklist
Requires:	fluxpbx-application-callcenter
Requires:	fluxpbx-application-cidlookup
Requires:	fluxpbx-application-conference
Requires:	fluxpbx-application-curl
Requires:	fluxpbx-application-db
Requires:	fluxpbx-application-directory
Requires:	fluxpbx-application-distributor
Requires:	fluxpbx-application-easyroute
Requires:	fluxpbx-application-enum
Requires:	fluxpbx-application-esf
Requires:	fluxpbx-application-expr
Requires:	fluxpbx-application-fifo
Requires:	fluxpbx-application-fsk
Requires:	fluxpbx-application-fsv
Requires:	fluxpbx-application-hash
Requires:	fluxpbx-application-httapi
Requires:	fluxpbx-application-http-cache
Requires:	fluxpbx-application-lcr
Requires:	fluxpbx-application-limit
Requires:	fluxpbx-application-memcache
Requires:	fluxpbx-application-nibblebill
Requires:	fluxpbx-application-redis
Requires:	fluxpbx-application-rss
Requires:	fluxpbx-application-signalwire
Requires:	fluxpbx-application-sms
Requires:	fluxpbx-application-snapshot
Requires:	fluxpbx-application-snom
Requires:	fluxpbx-application-soundtouch
Requires:	fluxpbx-application-spy
Requires:	fluxpbx-application-stress
Requires:	fluxpbx-application-valet_parking
Requires:	fluxpbx-application-video_filter
Requires:	fluxpbx-application-voicemail
Requires:	fluxpbx-application-voicemail-ivr
Requires:	fluxpbx-codec-passthru-amr
Requires:	fluxpbx-codec-bv
Requires:	fluxpbx-codec-passthru-g723_1
Requires:	fluxpbx-codec-passthru-g729
Requires:	fluxpbx-codec-h26x
Requires:	fluxpbx-codec-ilbc
Requires:	fluxpbx-codec-siren
Requires:	fluxpbx-database-pgsql
Requires:	fluxpbx-format-local-stream
Requires:	fluxpbx-format-native-file
Requires:	fluxpbx-format-portaudio-stream
Requires:	fluxpbx-format-tone-stream
Requires:	fluxpbx-lang-en

%description config-vanilla
Basic vanilla config set for the FluxPBX Open Source telephone platform.
...
sed -ie 's:confdir="${sysconfdir}/fluxpbx":confdir="$sysconfdir":' ./configure.ac
...
%{__mkdir} -p %{buildroot}%{_localstatedir}/cache/fluxpbx
...
# On SuSE:
%if 0%{?suse_version} > 100
%{__install} -D -m 744 build/fluxpbx.init.suse %{buildroot}/etc/rc.d/init.d/fluxpbx
%else
%if "%{?_unitdir}" == ""
# On RedHat like
%{__install} -D -m 0755 build/fluxpbx.init.redhat %{buildroot}/etc/rc.d/init.d/fluxpbx
%else
# systemd
%{__install} -Dpm 0644 build/fluxpbx.service %{buildroot}%{_unitdir}/fluxpbx.service
%{__install} -Dpm 0644 build/fluxpbx-tmpfiles.conf %{buildroot}%{_tmpfilesdir}/fluxpbx.conf
%endif
%endif
# On SuSE make /usr/sbin/rcfluxpbx a link to /etc/rc.d/init.d/fluxpbx
%if 0%{?suse_version} > 100
%{__mkdir} -p %{buildroot}/usr/sbin
%{__ln_s} -f /etc/rc.d/init.d/fluxpbx %{buildroot}/usr/sbin/rcfluxpbx
%endif
# Add the sysconfiguration file
%{__install} -D -m 744 build/fluxpbx.sysconfig %{buildroot}/etc/sysconfig/fluxpbx
# Add monit file
%{__install} -D -m 644 build/fluxpbx.monitrc %{buildroot}/etc/monit.d/fluxpbx.monitrc
%endif
######################################################################################################################
#
...
######################################################################################################################
#
#			Add a fluxpbx user with group daemon that will own the whole enchilada
#
######################################################################################################################
%pre
%ifos linux
if ! /usr/bin/id fluxpbx &>/dev/null; then
       /usr/sbin/useradd -r -g daemon -s /bin/false -c "The FluxPBX Open Source Voice Platform" -d %{LOCALSTATEDIR} fluxpbx || \
                %logmsg "Unexpected error adding user \"fluxpbx\". Aborting installation."
fi
%endif
...
chown fluxpbx:daemon /var/log/fluxpbx /var/run/fluxpbx

%if "%{?_unitdir}" == ""
chkconfig --add fluxpbx
%else
%tmpfiles_create fluxpbx
/usr/bin/systemctl -q enable fluxpbx.service
%endif

%preun
%{?systemd_preun fluxpbx.service}

%postun
%{?systemd_postun fluxpbx.service}
######################################################################################################################
#
#				On uninstallation get rid of the fluxpbx user
#
######################################################################################################################
%{?run_ldconfig:%run_ldconfig}
if [ $1 -eq 0 ]; then
    userdel fluxpbx || %logmsg "User \"fluxpbx\" could not be deleted."
fi
...
%dir %attr(0750, fluxpbx, daemon) %{LOCALSTATEDIR}
%dir %attr(0750, fluxpbx, daemon) %{LOCALSTATEDIR}/images
%dir %attr(0750, fluxpbx, daemon) %{DBDIR}
%dir %attr(0755, -, -) %{GRAMMARDIR}
%dir %attr(0755, -, -) %{HTDOCSDIR}
%dir %attr(0750, fluxpbx, daemon) %{logfiledir}
%dir %attr(0750, fluxpbx, daemon) %{runtimedir}
%dir %attr(0755, -, -) %{SCRIPTDIR}
#
#################################### Config Directory Structure #######################################################
#
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/autoload_configs
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/dialplan
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/dialplan/default
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/dialplan/public
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/dialplan/skinny-patterns
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/directory
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/directory/default
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/sip_profiles
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/sip_profiles/external
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/sip_profiles/external-ipv6
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/skinny_profiles
#
...
%ifos linux
%if "%{?_unitdir}" == ""
/etc/rc.d/init.d/fluxpbx
%else
%{_unitdir}/fluxpbx.service
%{_tmpfilesdir}/fluxpbx.conf
%endif
%config(noreplace) /etc/sysconfig/fluxpbx
%if 0%{?suse_version} > 100
/usr/sbin/rcfluxpbx
%endif
%endif
...
%config(noreplace) %attr(0644,-,-) /etc/monit.d/fluxpbx.monitrc
%endif
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/*.tpl
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/*.ttml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/extensions.conf
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/mime.types
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/abstraction.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/acl.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/amr.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/amrwb.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/alsa.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/amqp.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/av.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/avmd.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/blacklist.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/callcenter.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cdr_csv.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cdr_mongodb.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cdr_pg_csv.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cdr_sqlite.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cepstral.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/cidlookup.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/conference.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/conference_layouts.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/console.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/curl.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/db.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/dialplan_directory.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/directory.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/distributor.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/easyroute.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/enum.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/erlang_event.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/event_multicast.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/event_socket.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/fax.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/fifo.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/format_cdr.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/graylog2.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/hash.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/hiredis.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/httapi.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/http_cache.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/ivr.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/java.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/kazoo.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/lcr.conf.xml
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/memcache.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/modules.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/mongo.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/msrp.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/nibblebill.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/opal.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/oreka.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/osp.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/pocketsphinx.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/portaudio.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/post_load_modules.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/pre_load_modules.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/presence_map.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/redis.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/rss.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/rtmp.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/sangoma_codec.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/shout.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/signalwire.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/skinny.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/smpp.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/sms_flowroute.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/sndfile.conf.xml
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/syslog.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/timezones.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/translate.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/tts_commandline.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/unicall.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/verto.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/voicemail.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/voicemail_ivr.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/vpx.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/xml_cdr.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/xml_curl.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/xml_rpc.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/xml_scgi.conf.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/zeroconf.conf.xml
######################################################################################################################
#						Chatplans
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/chatplan/default.xml
######################################################################################################################
#						Dialplans
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/dialplan/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/dialplan/default/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/dialplan/public/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/dialplan/skinny-patterns/*.xml
######################################################################################################################
#						Fonts
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{_datadir}/fluxpbx/fonts/*.ttf
%config(noreplace) %attr(0640, fluxpbx, daemon) %{_datadir}/fluxpbx/fonts/OFL.txt
%config(noreplace) %attr(0640, fluxpbx, daemon) %{_datadir}/fluxpbx/fonts/README.fonts
######################################################################################################################
#						User Directories
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/directory/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/directory/default/*
######################################################################################################################
#							IVR Menus
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/ivr_menus/*.xml
######################################################################################################################
#							Sip Profiles
######################################################################################################################
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/sip_profiles/external-ipv6/*.xml
######################################################################################################################
#				Other Protocol Profiles (skinny)
######################################################################################################################
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/skinny_profiles/*.xml
######################################################################################################################
#						Grammar Files
######################################################################################################################
...
%dir %attr(0750, fluxpbx, daemon) %{_localstatedir}/cache/fluxpbx
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/opus.conf.xml
...
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/lua.conf.xml

%files perl
%{MODINSTDIR}/mod_perl*.so*
%{prefix}/perl/*
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/perl.conf.xml

%files python
%{MODINSTDIR}/mod_python*.so*
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/python.conf.xml
...
%{LIBDIR}/libicuuc.so
%endif
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/autoload_configs/v8.conf.xml
...
######################################################################################################################
%files lang-en
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/en
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/en/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/en/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/en/dir
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/en/ivr
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/en/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/en/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/en/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/en/dir/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/en/ivr/*.xml
%{MODINSTDIR}/mod_say_en.so*

%files lang-de
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/de
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/de/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/de/vm
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/de/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/de/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/de/vm/*.xml
%{MODINSTDIR}/mod_say_de.so*

%files lang-fr
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/fr
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/fr/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/fr/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/fr/dir
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/fr/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/fr/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/fr/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/fr/dir/*.xml
%{MODINSTDIR}/mod_say_fr.so*

%files lang-ru
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/ru
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/ru/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/ru/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/ru/dir
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/ru/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/ru/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/ru/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/ru/dir/*.xml
%{MODINSTDIR}/mod_say_ru.so*

%files lang-he
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/he/
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/he/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/he/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/he/dir
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/he/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/he/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/he/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/he/dir/*.xml
%{MODINSTDIR}/mod_say_he.so*

%files lang-es
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/es
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/es/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/es/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/es/dir
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/es/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/es/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/es/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/es/dir/*.xml
%{MODINSTDIR}/mod_say_es.so*

%files lang-pt
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/pt
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/pt/demo
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/pt/vm
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/pt/dir
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/pt/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/pt/demo/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/pt/vm/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/pt/dir/*.xml
%{MODINSTDIR}/mod_say_pt.so*

%files lang-sv
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/sv
%dir %attr(0750, fluxpbx, daemon) %{sysconfdir}/lang/sv/vm
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/sv/*.xml
%config(noreplace) %attr(0640, fluxpbx, daemon) %{sysconfdir}/lang/sv/vm/*.xml
...
%files	-n python-ESL
%attr(0644, root, bin) /usr/lib*/python*/site-packages/fluxpbx.py*
...
* Thu Sep 11 2014 - krice@fluxpbx.org
- add and fix mod_verto and mod_rtc
* Mon Jun 02 2014 - krice@fluxpbx.org
...
- Fix build on master
* Fri Jun 28 2013 - krice@fluxpbx.org
- Add module for VP8
* Wed Jun 19 2013 - krice@fluxpbx.org
- tweak files included for vanilla configs
* Wed Sep 19 2012 - krice@fluxpbx.org
- Add support for Spanish and Portuguese say language modules
* Thu Jan 26 2012 - krice@fluxpbx.org
...
- new hash module config file added to fluxpbx.spec
* Mon Jul 19 2010 - michal.bielicki@seventhsignal.de
- Adjusted sphinxbase
...
* Wed Nov 25 2009 - brian@fluxpbx.org
- added mod_bv.so
...
- added patch by Igor Neves <neves.igor@gmail.com>: Added some checkup in %post and %postun to prevent upgrades from removing fluxpbx user

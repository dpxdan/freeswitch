...
OutputBaseFilename=fluxpbx-1.0.4
...
Source: vcredist_x86.exe; Components: FluxPBX; DestDir: {tmp}
...
Source: G:\fluxpbx-1.0.4\Release\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist; Components: FluxPBX
Source: G:\fluxpbx-1.0.4\Release_CLR\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist; Components: FluxPBX
Source: G:\fluxpbx_dev\contrib\jmesquita\fsgui\bin\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist; Components: fsgui
...
Source: G:\fluxpbx_dev\Release\php_ESL.dll; DestDir: {app}\wamp\bin\php\php5.3.0\ext; Flags: ignoreversion recursesubdirs; Components: FreePBX_WAMP
...
[Run]
Filename: {tmp}\vcredist_x86.exe; Description: Microsoft Visual C++ 2008 Redistributable Package (x86); Components: FluxPBX; Parameters: /q
...
[_ISToolDownload]
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-8000-1.0.11.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-8000-1.0.11.tar.gz; Components: sound_files_8khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-16000-1.0.11.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-16000-1.0.11.tar.gz; Components: sound_files_16khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-32000-1.0.11.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-32000-1.0.11.tar.gz; Components: sound_files_32khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-48000-1.0.11.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-48000-1.0.11.tar.gz; Components: sound_files_48khz

...
AppName=FluxPBX
AppVerName=FluxPBX svn 16456
AppPublisher=FluxPBX
...
OutputBaseFilename=fluxpbx_freepbx
...
Source: fluxpbx.ico; DestDir: {app}; Components: FluxPBX
Source: vcredist_x86.exe; Flags: 32bit; Components: FluxPBX; DestDir: {tmp}; Check: not Is64BitInstallMode
Source: vcredist_x64.exe; Flags: 64bit; Components: FluxPBX; DestDir: {tmp}; Check: Is64BitInstallMode
Source: freepbx.ico; DestDir: {app}; Components: FreePBX_WAMP
Source: expsound.bat; DestDir: {app}; Components: FluxPBX
...
; 32 bit release
Source: {#FluxPBX_32bit}\*.exe; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 32bit; Components: FluxPBX; Check: not Is64BitInstallMode
Source: {#FluxPBX_32bit}\*.dll; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 32bit; Components: FluxPBX; Check: not Is64BitInstallMode
Source: {#FluxPBX_32bit}\*.lib; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 32bit; Components: FluxPBX; Check: not Is64BitInstallMode
Source: {#FluxPBX_32bit}\mod\*; DestDir: {app}\mod; Flags: ignoreversion  onlyifdoesntexist 32bit; Components: FluxPBX; Check: not Is64BitInstallMode
Source: ..\..\..\Release_CLR\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist 32bit; Components: FluxPBX; Check: not Is64BitInstallMode
; 64 bit release
Source: {#FluxPBX_64bit}\*.exe; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 64bit; Components: FluxPBX; Check: Is64BitInstallMode
Source: {#FluxPBX_64bit}\*.dll; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 64bit; Components: FluxPBX; Check: Is64BitInstallMode
Source: {#FluxPBX_64bit}\*.lib; DestDir: {app}; Flags: ignoreversion  onlyifdoesntexist 64bit; Components: FluxPBX; Check: Is64BitInstallMode
Source: {#FluxPBX_64bit}\mod\*; DestDir: {app}\mod; Flags: ignoreversion  onlyifdoesntexist 64bit; Components: FluxPBX; Check: Is64BitInstallMode
Source: ..\..\..\x64\Release_CLR\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist 64bit; Components: FluxPBX; Check: Is64BitInstallMode

; shared by 32 and 64 bit install
Source: {#FluxPBX_32bit}\conf\*; DestDir: {app}\conf; Flags: ignoreversion recursesubdirs createallsubdirs  onlyifdoesntexist; Components: FluxPBX
...
Source: {#FluxPBX_32bit}\php_ESL.dll; DestDir: {app}\wamp\bin\php\php5.3.0\ext; Flags: ignoreversion recursesubdirs; Components: FreePBX_WAMP
...
[Icons]
Name: {group}\FluxPBX; Filename: {app}\FluxPbx.exe; Components: FluxPBX; IconFilename: {app}\fluxpbx.ico; IconIndex: 0; WorkingDir: {app}
Name: {commondesktop}\FluxPBX; Filename: {app}\FluxPbx.exe; Tasks: desktopicon; Components: FluxPBX; IconFilename: {app}\fluxpbx.ico; IconIndex: 0; WorkingDir: {app}
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\FluxPBX; Filename: {app}\FluxPbx.exe; Tasks: quicklaunchicon; Components: FluxPBX; IconFilename: {app}\fluxpbx.ico; IconIndex: 0; WorkingDir: {app}
Name: {commondesktop}\fsgui; Filename: {app}\fsgui.exe; Tasks: desktopicon; Components: fsgui; IconFilename: {app}\fluxpbx.ico; IconIndex: 0; WorkingDir: {app}\plugins
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\fsgui; Filename: {app}\fsgui.exe; Tasks: quicklaunchicon; Components: fsgui; IconFilename: {app}\fluxpbx.ico; IconIndex: 0; WorkingDir: {app}\plugins
...
[Run]
Filename: {tmp}\vcredist_x86.exe; Description: Microsoft Visual C++ 2008 Redistributable Package (x86); Components: FluxPBX; Parameters: /q; Flags: 32bit; Check: not Is64BitInstallMode
Filename: {tmp}\vcredist_x64.exe; Description: Microsoft Visual C++ 2008 Redistributable Package (x64); Components: FluxPBX; Parameters: /q; Flags: 64bit; Check: Is64BitInstallMode
...
Filename: {app}\fluxpbx.exe; Description: Launch FluxPBX now; Flags: shellexec postinstall skipifsilent; Components: FluxPBX
...
Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-pt-BR-karina-8000-1.0.11.tar.gz; Components: sound_files_8khz; WorkingDir: {tmp}
Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-music-8000-1.0.8.tar.gz; Components: sound_files_8khz; WorkingDir: {tmp}; Tasks: ; Languages: 

Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-pt-BR-karina-16000-1.0.11.tar.gz; Components: sound_files_16khz; WorkingDir: {tmp}; Tasks: ; Languages: 
Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-music-16000-1.0.8.tar.gz; Components: sound_files_16khz; WorkingDir: {tmp}; Tasks: ; Languages: 

Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-pt-BR-karina-32000-1.0.11.tar.gz; Components: sound_files_32khz; WorkingDir: {tmp}; Tasks: ; Languages: 
Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-music-32000-1.0.8.tar.gz; Components: sound_files_32khz; WorkingDir: {tmp}; Tasks: ; Languages: 

Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-pt-BR-karina-48000-1.0.11.tar.gz; Components: sound_files_48khz; WorkingDir: {tmp}; Tasks: ; Languages: 
Filename: {app}\expsound.bat; Parameters: {tmp} {app} fluxpbx-sounds-music-48000-1.0.8.tar.gz; Components: sound_files_48khz; WorkingDir: {tmp}; Tasks: ; Languages: 
...
[UninstallRun]
Filename: {app}\wamp\uninstall_services.bat; Components: FreePBX_WAMP; Flags: runhidden
Filename: {app}\fluxpbx.exe; Flags: runhidden; Parameters: -stop; WorkingDir: {app}

[_ISToolDownload]
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-8000-1.0.12.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-8000-1.0.11.tar.gz; Components: sound_files_8khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-16000-1.0.12.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-16000-1.0.11.tar.gz; Components: sound_files_16khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-32000-1.0.12.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-32000-1.0.11.tar.gz; Components: sound_files_32khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-pt-BR-karina-48000-1.0.12.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-pt-BR-karina-48000-1.0.11.tar.gz; Components: sound_files_48khz

Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-music-8000-1.0.8.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-music-8000-1.0.8.tar.gz; Components: sound_files_8khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-music-16000-1.0.8.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-music-16000-1.0.8.tar.gz; Components: sound_files_16khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-music-32000-1.0.8.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-music-32000-1.0.8.tar.gz; Components: sound_files_32khz
Source: https://sbcdev4.flux.net.br/freeswitch/sounds/fluxpbx-sounds-music-48000-1.0.8.tar.gz; DestDir: {tmp}; DestName: fluxpbx-sounds-music-48000-1.0.8.tar.gz; Components: sound_files_48khz
...
[Components]
Name: FluxPBX; Description: FluxPBX core components; Flags: fixed; Types: custom compact full; Languages: 
...
destFile := fspathWithSlashes+'/wamp/www/freepbx-v3/modules/fluxpbx/config/fluxpbx.php';
...
//begin
  ...
  StringChange (srcContents, '/opt/fluxpbx', fspathWithSlashes);
  StringChange (srcContents, '/usr/local/fluxpbx', fspathWithSlashes);

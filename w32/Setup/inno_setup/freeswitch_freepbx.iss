...
Filename: {app}\expsound.bat; Parameters: {tmp} {app} freeswitch-sounds-pt-BR-karina-8000-1.0.11.tar.gz; Components: sound_files_8khz; WorkingDir: {tmp}
...
Filename: {app}\expsound.bat; Parameters: {tmp} {app} freeswitch-sounds-pt-BR-karina-16000-1.0.11.tar.gz; Components: sound_files_16khz; WorkingDir: {tmp}; Tasks: ; Languages: 
...
Filename: {app}\expsound.bat; Parameters: {tmp} {app} freeswitch-sounds-pt-BR-karina-32000-1.0.11.tar.gz; Components: sound_files_32khz; WorkingDir: {tmp}; Tasks: ; Languages: 
...
Filename: {app}\expsound.bat; Parameters: {tmp} {app} freeswitch-sounds-pt-BR-karina-48000-1.0.11.tar.gz; Components: sound_files_48khz; WorkingDir: {tmp}; Tasks: ; Languages: 
...
[_ISToolDownload]
Source: http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-8000-1.0.12.tar.gz; DestDir: {tmp}; DestName: freeswitch-sounds-pt-BR-karina-8000-1.0.11.tar.gz; Components: sound_files_8khz
Source: http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-16000-1.0.12.tar.gz; DestDir: {tmp}; DestName: freeswitch-sounds-pt-BR-karina-16000-1.0.11.tar.gz; Components: sound_files_16khz
Source: http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-32000-1.0.12.tar.gz; DestDir: {tmp}; DestName: freeswitch-sounds-pt-BR-karina-32000-1.0.11.tar.gz; Components: sound_files_32khz
Source: http://files.freeswitch.org/releases/sounds/freeswitch-sounds-pt-BR-karina-48000-1.0.12.tar.gz; DestDir: {tmp}; DestName: freeswitch-sounds-pt-BR-karina-48000-1.0.11.tar.gz; Components: sound_files_48khz

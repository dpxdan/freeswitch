/*
 * azure.h for FluxPBX Modular Media Switching Software Library / Soft-Switch Application
 ...
 * License.
 *
 * The Original Code is aws.h for FluxPBX Modular Media Switching Software Library / Soft-Switch Application
 *

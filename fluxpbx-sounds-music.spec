...
Summary:	FluxPBX Music on Hold soundfiles
Name:		fluxpbx-sounds-music
Version:	1.0.52
Release:	1%{?dist}
License:	MPL
...
Source0:	https://sbcdev4.flux.net.br/freeswitch/sounds/%{name}-8000-%{version}.tar.gz
Source1:        https://sbcdev4.flux.net.br/freeswitch/sounds/%{name}-16000-%{version}.tar.gz
Source2:        https://sbcdev4.flux.net.br/freeswitch/sounds/%{name}-32000-%{version}.tar.gz
Source3:        https://sbcdev4.flux.net.br/freeswitch/sounds/%{name}-48000-%{version}.tar.gz
BuildArch:	noarch
BuildRequires:	bash
Requires:	fluxpbx
Requires:       fluxpbx-sounds-music-8000 = %{version}
Requires:       fluxpbx-sounds-music-16000 = %{version}
Requires:       fluxpbx-sounds-music-32000 = %{version}
Requires:       fluxpbx-sounds-music-48000 = %{version}
BuildRoot:      %(mktemp -ud %{_tmppath}/%{name}-%{version}-%{release}-XXXXXX)

%description
FluxPBX Music On Hold soundfiles package that installs the 8KHz, 16KHz,
32KHz and 48KHz RPMs


%package -n fluxpbx-sounds-music-8000
Summary:        FluxPBX 8kHz Music On Hold soundfiles
Group:          Productivity/Telephony/Servers
BuildArch:      noarch
Requires:       fluxpbx

%description -n fluxpbx-sounds-music-8000
FluxPBX 8kHz Music On Hold soundfiles


%package -n fluxpbx-sounds-music-16000
Summary:        FluxPBX 16kHz Music On Hold soundfiles
Group:          Productivity/Telephony/Servers
BuildArch:      noarch
Requires:       fluxpbx

%description -n fluxpbx-sounds-music-16000
FluxPBX 16kHz Music On Hold soundfiles


%package -n fluxpbx-sounds-music-32000
Summary:        FluxPBX 32kHz Music On Hold soundfiles
Group:          Productivity/Telephony/Servers
BuildArch:      noarch
Requires:       fluxpbx

%description -n fluxpbx-sounds-music-32000
FluxPBX 32kHz Music On Hold soundfiles


%package -n fluxpbx-sounds-music-48000
Summary:        FluxPBX 48kHz Music On Hold soundfiles
Group:          Productivity/Telephony/Servers
BuildArch:      noarch
Requires:       fluxpbx

%description -n fluxpbx-sounds-music-48000
FluxPBX 48kHz Music On Hold soundfiles
...
- Fix up for FluxPBX FHS and AutoBuild System
